      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="md:col-span-4 lg:col-span-4">
            ...
            >
              {/* 🔹 Logo with fallback to /logo.png */}
              <img
            ...
            {/* Social icons – smooth hover lift */}
          ...
          {/* Quick Links */}
          <div className="md:col-span-2 md:col-start-6 lg:col-span-2 lg:col-start-6">
          ...
          <div className="md:col-span-2 lg:col-span-2">
            ...
            <ul className="space-y-3.5">
              ...
              <li>
                <a
                  href={organization.supportUrl ?? 'mailto:support@communityhub.com'}
                  className="text-gray-500 hover:text-[var(--color-primary)] text-sm transition-colors duration-200 hover:translate-x-0.5 inline-block"
                >
                  Contact Support
                </a>
