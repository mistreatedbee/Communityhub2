...
export function EnterLicensePage() {
  ...
  return (
    <>
      {/* Animated background with subtle moving gradient and dot pattern */}
      ...
      <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8 animate-fade-in-down">
          ...
          <p className="text-base text-gray-600 mt-3 max-w-xs mx-auto">
            A valid license is required to create and manage your own community hub.
          </p>
          <p className="text-sm text-gray-500 mt-2">
            Already have an account?{' '}
            <Link
              to="/login"
              className="font-medium text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] underline-offset-2 hover:underline transition"
            >
              Sign in
            </Link>
          </p>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-5xl grid md:grid-cols-2 gap-8 px-4">
          ...
          {/* Right card – Information & next steps */}
          <Card className="shadow-2xl border-0 ring-1 ring-gray-200/80 hover:ring-gray-300/80 transition-all duration-300 backdrop-blur-sm bg-white/95">
            <CardContent className="p-8">
      ...
      {/* Keyframe animations (add to your global CSS) */}
      <style>{`
