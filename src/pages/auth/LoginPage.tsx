  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center mb-8">
        ...
        <p className="text-sm text-gray-600 mt-2">Admin login for organizations managing a Community Hub tenant.</p>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-3xl grid md:grid-cols-2 gap-6">
        ...
        <Card className="shadow-xl border-0 ring-1 ring-gray-200">
          <CardContent className="p-8 space-y-4">
            ...
            <p className="text-sm text-gray-600">Onboarding is license-first for new community tenants.</p>

            <Link to="/enter-license">
              <Button className="w-full" leftIcon={<KeyRound className="w-4 h-4" />}>
                Enter License Key
              </Button>
            </Link>
            ...
            <p className="text-xs text-gray-500 pt-2">
              Existing clients: Enter license, then create your admin account and community workspace.
            </p>
          </CardContent>
        </Card>
      </div>
